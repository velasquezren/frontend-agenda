 ...
 *
 * El original está en `public/favicon.svg` (mismo trazado, color fijo), que es
 * el que usan el favicon y los iconos de la PWA.
 */
@Component({
  selector: 'app-logo',
  template: `
    ...
    >
      <path
        d="M46.9,532.8c0-282.3,228.9-511.2,511.3-511.2c178.8,0,336.2,91.8,427.5,230.8C901.6,143.3,769.7,73,621.3,73
      ...
      />
      <path
        d="M236.4,567.6c0-200.3,162.4-362.6,362.7-362.6c126.8,0,238.5,65.1,303.3,163.7
      ...
      />
      <path
        d="M803.5,498c15.6-22.9,41.9-38,71.7-38c47.8,0,86.6,38.8,86.6,86.6c0,47.8-38.8,86.6-86.6,86.6
           c-1.4,0-2.7,0-4.1-0.1c33.3-8.6,57.9-38.8,57.9-74.8c0-42.6-34.6-77.2-77.2-77.2C833.5,481,816.7,487.4,803.5,498z"
      />
      <path
        fill-rule="evenodd"
        clip-rule="evenodd"
        d="M442.3,770.7c0,0,37.3-285.7,360.3-223.6C805.1,547.5,541.7,564.4,442.3,770.7z"
      />
    </svg>
  `,
